...
(function(root) {
  ...
  var exports = this;
  (function() {
  var Events, extend, get, indexOf, isArrayIndex, serializeObject, _ref,
    __slice = [].slice;
  ...
  exports.Collection = (function() {
    ...
    Collection.prototype.splice = function() {
      var deleteCount, deleted, index, list, old, start, _i, _ref1, _ref2;
      ...
      for (index = _i = _ref1 = this.length, _ref2 = this.length + deleteCount - 1; _ref1 <= _ref2 ? _i <= _ref2 : _i >= _ref2; index = _ref1 <= _ref2 ? ++_i : --_i) {
        delete this[index];
      }
      this.trigger("update", old, this);
      this.trigger("change", this);
  ...
  Properties = {
    ...
    set: function(attributes, value) {
      var name, names, _i, _len, _ref1, _results;
      ...
      if (!define) {
        ...
        for (_i = 0, _len = names.length; _i < _len; _i++) {
          name = names[_i];
          _results.push(this[name] = this.get(name));
        }
        return _results;
      }
    },
  ...
  var exports = this;
  (function() {
  var Associations, Cache, Model, Properties, capitalize, extend, _ref, _ref1,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __slice = [].slice;
  ...
  var exports = this;
  (function() {
  var Cache, Properties, Serenade, extend, globalDependencies, ua, _ref, _ref1;
  ...
  if ((ua = typeof window !== "undefined" && window !== null ? (_ref1 = window.navigator) != null ? _ref1.userAgent : void 0 : void 0)) {
    Serenade.isIE7 = /MSIE 7/.test(navigator.userAgent);
  }
  ...
  var exports = this;
  (function() {
  var Collection, Compile, DynamicNode, Node, Property, Serenade, compile, createElement, get, getValue, preventDefault, set, _ref;
  ...
  createElement = function(ast) {
    var name, p, _i, _len, _ref1;
    if (!(Serenade.isIE7 && ast.name === 'input')) {
      return Serenade.document.createElement(ast.name);
    }
    _ref1 = ast.properties;
  ...
  Compile = {
    element: function(ast, model, controller) {
      ...
      if ((_ref1 = ast.classes) != null ? _ref1.length : void 0) {
        element.className = ast.classes.join(' ');
      }
      _ref2 = ast.children;
